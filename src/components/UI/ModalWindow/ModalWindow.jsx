...
const ModalWindow = ({ visible, setVisible, posts, create }) => {
  ...
  function handleChange() {
    try {
      ...
      console.log(e, "Фотография не выбрана");
    }
  }
  ...
  const sendGoogleBase = (e) => {
    ...
    if (urlTakeImg) {
      ...
      console.log("выберите фотографию");
    }
  };
    ...
    <div className={rootClasses.join(" ")} onClick={() => setVisible(false)}>
      ...
      >
        ...
        <label
          id="dropFile"
          for="image_uploads"
          className="ModalWindow__content-img"
        >
          <img src={urlTakeImg ? urlTakeImg : Decoration} />
        </label>
        <button
          className="ModalWindow__content-buttonClose"
        ...
        <input
          ...
          id="image_uploads"
          className="ModalWindow__content-img-input"
          type="file"
          name="photo"
