                ...
                <div className='FirstPage__main'>
                    ...
                    <div className='FirstPage__main-text'>
                        <div className='FirstPage__main-text-p'>
                            ...
                            <p1>Здесь вы найдете множество колье, браслетов, поясов и других украшений ручной работы. Наши изделия помогут сделать Ваш танец восхитительным и элегантным.</p1>
                        </div>
                    </div>
                </div>
