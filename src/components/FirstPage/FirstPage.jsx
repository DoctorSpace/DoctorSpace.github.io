  ...
  return (
    <div className="FirstPag">
        ...
        <div className="FirstPage__main">
          <div className="FirstPage__main-text">
            <div className="FirstPage__main-text-p">
              <p1>
                Добро пожаловать в мир восточных танцев и элегантных
                аксессуаров! Наш магазин - это место, где таинственная красота
                Востока соединяется с пышными движениями и страстью танца.
              </p1>
              <p1>
                Здесь вы найдете множество колье, браслетов, поясов и других
                украшений ручной работы. Наши изделия помогут сделать Ваш танец
                восхитительным и элегантным.
              </p1>
            </div>
          </div>
        </div>
      ...
      <div className="FirstPage__main-btn">
        ...
        <Link to="/Contact" className="Btn-second">
          Связаться
        </Link>
      </div>
    </div>
