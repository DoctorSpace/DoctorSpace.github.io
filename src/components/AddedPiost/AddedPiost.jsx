        ...
        <div>
            ...
            <div className='AddedPiost'>
                ...
                <div className='AddedPiost__Numder'>
                    <div>
                        <p>Начало</p>
                        <input type="number" id='StartNumber' placeholder='25' ref={StartNumber}></input>
                    </div>

                    <div>
                        <p>Конец</p>
                        <input type="number" id='EndNumber' placeholder='50' ref={EndNumber}></input>
                    </div>
            ...
            <div className='AddedPiost'>
                ...
                <a href="https://console.firebase.google.com/u/0/project/isadora-shop-a6e7c/storage/isadora-shop-a6e7c.appspot.com/files" target="_blank">firebase</a>
            </div>
